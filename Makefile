...
run-local: devops-init
	sudo ansible-playbook jenkins.yml -i inventory --limit karol-local

run-aws-jenkins: devops-init
	ansible-playbook jenkins.yml -i jenkins-aws_ec2.yml --key-file /home/karol/.ssh/aws-karol-frankfurt.pem
